...
public sealed class Plugin : IDalamudPlugin
{
    ...
    private readonly ComposeWindow composeWindow;
        ...
        IFramework framework)
    {
        ...
        windowSystem.AddWindow(composeWindow);
        ...
        openLogCommandInfo = new CommandInfo(OnOpenLogCommand) { HelpMessage = Loc.T("Command.Help.OpenLog") };
        ...
        this.pluginInterface.UiBuilder.OpenMainUi += ToggleComposeWindow;
    ...
    public void ToggleChatLogWindow() => chatLogWindow.Toggle();
    ...
    public void SendChunks(List<string> chunks, string originalDraft)
    {
        ...
        sender.Enqueue(commands, Configuration.DelayMs);
    ...
    private void OnOpenCommand(string command, string args) => composeWindow.Toggle();

    private void OnOpenLogCommand(string command, string args) => chatLogWindow.Toggle();
    ...
    private void OnLanguageChanged(string langCode)
    {
        ...
        composeWindow.WindowName = WindowTitles.Compose;
        settingsWindow.WindowName = WindowTitles.Settings;
        chatLogWindow.WindowName = WindowTitles.Read;
    }

    private void DrawUi() => windowSystem.Draw();

    private void ToggleComposeWindow() => composeWindow.Toggle();

    public void Dispose()
    {
        pluginInterface.UiBuilder.Draw -= DrawUi;
        pluginInterface.UiBuilder.OpenMainUi -= ToggleComposeWindow;
